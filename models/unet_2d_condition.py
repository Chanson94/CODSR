...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        modulation_params: Tuple[Optional[torch.Tensor], Optional[torch.Tensor]] = None,
        # modulation_params: Optional[torch.Tensor] = None,
        ...
        if modulation_params:
            scale, shift = modulation_params
            sample = sample * (scale + 1) + shift
        ...
        # return latent, UNet2DConditionOutput(sample=sample)
