...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_image', '-g', type=str, default='preset/datasets/test_dataset/input', help='path to the input image')
    ...
    parser.add_argument("--codsr_path", type=str, default=None)
    parser.add_argument("--vae_path", default=None, type=str)
    parser.add_argument("--model_path", type=str, default="preset/models/003_realSR_BSRGAN_DFOWMFC_s64w8_SwinIR-L_x4_GAN.pth")
    ...
    parser.add_argument("--latent_tiled_size", type=int, default=150) 
    parser.add_argument("--latent_tiled_overlap", type=int, default=50) 

    args = parser.parse_args()
    
    # # initialize the model

    model = CODSR_test(args)
    model = model.cuda()
