...
class LocalImageDataset(data.Dataset):
    def __init__(self, 
        ...
        self.data_collection = {'nature': (np.array(nature_paths), np.array(nature_lr_paths)), 'face': (np.array(face_paths), np.array(lq_face_paths))}
        self.data_lens = {'nature': len(nature_paths), 'face': len(face_paths)}
        print(self.data_lens)
        self.data_lr_lens = {'nature': len(nature_lr_paths), 'face': len(lq_face_paths)}
        print(self.data_lens)
